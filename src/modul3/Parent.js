    ...
    render() {
        return (
            <div>
                ...
                <button onClick={this.ubahkomponen1}>{this.state.komponen1 ? 'SEMBUNYIKAN' : 'TUNJUKAN'} Anak-1!</button>
                <br />
                {this.state.komponen2 ? <Child2 /> : ''}
                <button onClick={this.ubahkomponen2}>{this.state.komponen2 ? 'SEMBUNYIKAN' : 'TUNJUKAN'} Anak-2!</button>
            </div>
        );
    }
}
